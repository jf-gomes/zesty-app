    ...
    return (
        <View style={styles.container}>
            <View style={styles.form}>
                ...
                <Text>Não possui uma conta? <Text style={styles.link} onPress={() => navigation.navigate('signup')}>Cadastre-se agora!</Text></Text>
                <Text>Esqueceu a senha? <Text style={styles.link}>Recuperar!</Text></Text>
